    ...
    public void addBrandFunction(){
        ...
        class AsyncTaskUploadClass extends AsyncTask<Void,Void,String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                progressDialog = ProgressDialog.show(AddBrandProductActivity.this,"Loading...","Please Wait",false,false);
            }
            ...
            protected void onPostExecute(String s) {
                ...
                Toast.makeText(AddBrandProductActivity.this,"Thêm thành công",Toast.LENGTH_LONG).show();
